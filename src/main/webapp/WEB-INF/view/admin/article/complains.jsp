...
$(function(){
 ...
 function query(){
	 //获取投诉类型
	 var b=$("[name=endNum]").val();
	 var b1=$("[name=startNum]").val();
	 alert(b1)
     if(b1>90){
    	 alert("错误")
     }
...
<body>
	<div class="container-fluid">
	 <form id="form1">
		<div class="form-group form-inline">
			...
			投诉类型:<select name="typename" class="form-control" id="typename">
	...
	<table class="table table-bordered table-hover">
		<tr align="center">
			...
			<td>投诉内容</td>
			<td>投诉人</td>
			<td><a href="javascript:myOrder('created')">投诉时间</a></td>
			<td><a href="javascript:myOrder('complain_num')">投诉数量</a></td>
			<td>操作</td>
		</tr>
